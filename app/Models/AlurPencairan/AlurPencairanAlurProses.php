...
class AlurPencairanAlurProses extends Model
{
    ...
    const ALUR_KIRIM_EMAIL_LIST_CAIR_KE_PAK_NOVI = 'kirim_email_list_cair_ke_pak_novi';
    const ALUR_SHARE_EMAIL_KE_ACCOUNTING = 'share_email_ke_accounting';
    ...
    const ALUR_PROSESES = [
        [
            'key' => self::ALUR_KIRIM_EMAIL_LIST_CAIR_KE_PAK_NOVI,
            'name' => 'Kirim email list cair ke pak Novi',
            'role' => AlurPencairan::ROLE_ACC_JAPAN,
        ],
        [
            'key' => self::ALUR_SHARE_EMAIL_KE_ACCOUNTING,
            'name' => 'Share email ke Accounting',
